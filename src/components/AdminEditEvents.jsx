...
const AdminEditEvents = ({evnt}) => {
    ...
    const[eventDetails,setEventDetails] = useState({eventName:evnt?.eventName,eventCost:evnt?.eventCost,eventDescription:evnt?.eventDescription})

    const [show, setShow] = useState(false);
    const handleClose = () => setShow(false);
    const handleShow = () => {
        setShow(true);
        setEventDetails({eventName:evnt?.eventName,eventCost:evnt?.eventCost,eventDescription:evnt?.eventDescription})
    }
