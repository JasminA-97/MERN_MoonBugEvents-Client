...
const Contact = () => {
  return (
    <div className="contact pt-5 mt-5">
        <Container-fluid className="text-center">
            <h1 style={{fontFamily: "Dancing Script, cursive"}} className='mb-5  fw-bolder text-center'>Contact Us</h1>
            <div className="row ms-5 me-5">
                ...
                <div className="col-lg-4">
                    <table className="table mt-4">
                        <tbody>
                            <tr>
                                <td className="pr-4 p-3" style={{ border: 'none',fontSize:'18px' }}><i className="border rounded-5 p-2 bg-info text-white fs-3 fa-solid fa-location-dot"></i></td>
                            ...
                            <tr>
                                <td style={{ border: 'none' }} className="pr-4 p-3"><i className="border rounded-5 p-2 bg-info text-white fs-3 fa-solid fa-phone"></i></td>
                                <td style={{ border: 'none',fontSize:'18px' }} className='p-3'>9946124710</td>
                            </tr>
                            <tr>
                                <td style={{ border: 'none' }} className="pr-4 p-3"><i className="border rounded-5 p-2 bg-info text-white fs-3 fs-3 fa-solid fa-clock"></i></td>
                                <td style={{ border: 'none',fontSize:'18px' }} className='p-3'>Mon-Sun: 10:00AM - 07:00PM</td>
                            </tr>
                            <tr>
                                <td style={{ border: 'none' }} className="pr-4 p-3"><i className="border rounded-5 p-2 bg-info text-white fs-3 fs-3 fa-solid fa-envelope"></i></td>
